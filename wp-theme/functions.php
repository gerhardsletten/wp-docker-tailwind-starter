...
add_action('customize_register', function ($wp_customize) {
  ...
  $wp_customize->add_setting( 'themeconfig_facebook', array(
    'default'        => '',
  ) );

  $wp_customize->add_control( 'themeconfig_facebook', array(
    'label'   => 'Facebook url',
    'section' => 'theme_settings',
    'type'    => 'text',
  ) );
  $wp_customize->add_setting( 'themeconfig_instagram', array(
    'default'        => '',
  ) );

  $wp_customize->add_control( 'themeconfig_instagram', array(
    'label'   => 'Instagram url',
    'section' => 'theme_settings',
    'type'    => 'text',
  ) );
  
  $wp_customize->add_setting( 'themeconfig_footer_text', array(
    'default'        => '',
  ) );

  $wp_customize->add_control( 'themeconfig_footer_text', array(
    'label'   => 'Footer text',
    'section' => 'theme_settings',
    'type'    => 'textarea',
  ) );
